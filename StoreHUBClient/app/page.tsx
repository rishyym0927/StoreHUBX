              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  {c.repoLink && c.repoLink.owner && c.repoLink.repo ? (
                    ...
                    <div className="ml-2 text-xs px-2 py-1 rounded-md bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 shrink-0">
                      ❌ Not Linked
                    </div>
                  )}
                </div>
                ...
                {c.repoLink && c.repoLink.owner && c.repoLink.repo ? (
                  ...
                  <div className="mt-3 pt-3 border-t text-xs opacity-60 flex items-center gap-1 text-red-600">
