      ...
      <div className="min-h-screen bg-linear-to-b from-gray-50 to-white dark:from-gray-900 dark:to-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-8 text-center">
            ...
            <h1 className="text-4xl font-bold mb-3 bg-clip-text text-transparent bg-linear-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="p-4 bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold">Browse Repos</h3>
              </div>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold">Navigate Folders</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold">Link & Sync</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
