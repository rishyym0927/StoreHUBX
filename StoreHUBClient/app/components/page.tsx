      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-medium">
            {loading ? "Loading..." : `${totalComponents} component${totalComponents !== 1 ? "s" : ""} (Page ${currentPage} of ${totalPages || 1})`}
          </h2>
        </div>
            ...
            {totalPages > 1 && (
              <div className="mt-8 flex items-center justify-center gap-4 flex-wrap">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border text-sm transition-all hover:bg-gray-100 dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  ← Previous
                </button>
                ...
                <div className="flex items-center gap-2 flex-wrap justify-center">
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((pageNum) => {
                    ...
                    if (showEllipsis) {
                      return (
                        <span key={pageNum} className="px-2 text-sm opacity-60">
                          ...
                        </span>
                      );
                    }
